...
export default function RewardFee({ provider }) {
    return (
        <Flex direction="column" gap={"2px"} alignItems={"center"}>
            <Tooltip label={"🏗️ Reward calculation coming soon! 🏗️"} placement={"top"} closeOnClick={false} gutter={1}>
            ...
            <Tooltip label={"Cost to use this provider"} placement={"top"} closeOnClick={false} gutter={1}>
